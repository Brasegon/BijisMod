...
public class Test extends Feature<NoFeatureConfig> {
    ...
    public boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, NoFeatureConfig config) {
        ...
        if (!reader.getBlockState(pos).isIn(Blocks.GRASS_BLOCK)) {
            return false;
        } else {
                ...
                for(int i1 = -l; i1 <= l; ++i1) {
                    ...
                    for(int j1 = -l; j1 <= l; ++j1) {
                        ...
                        if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(rand.nextFloat() > 0.75F))) {
                            ...
                            if (blockstate.isAir(reader, pos.add(i1, k, j1)) || block == Blocks.GRASS_BLOCK || block == Blocks.ICE) {
            ...
            for(int l1 = -k1; l1 <= k1; ++l1) {
                for(int i2 = -k1; i2 <= k1; ++i2) {
                    ...
                    while(blockpos.getY() > 50) {
                        ...
                        if (!blockstate1.isAir(reader, blockpos) && block1 != Blocks.GRASS_BLOCK && block1 != Blocks.ICE && block1 != Blocks.PACKED_ICE) {
                            break;
                        }
